...
Emp_details_choice={"Name":"Employee Name".upper(),"Employee Id":"Employee ID","Asset Id":"Asset Id","PTag":"PTAG #","Serial Number":"Serial No"}
#------------------------------QC-------------------------------------------------#
...
QC_list_Details=["EMPLOYEE NAME","EMPLOYEE ID","NAME OF PROJECT","INVOCES NUMBER","DC NUMBER",'MNC', 'Description of Goods', "QUANTITY","SERIAL NUMBER", 'PTAG NUMBER', 'DATE OF RECIVED', 'DATE OF RETURN', 'RECEIVED FROM', 'STATUS']
#-------------------------------china--------------------------------#
...
#-------------------------TS-----------------------------------------------------#
TS_Details={"Product":"PRODUCT",	"Asset Id":'ASSET ID',	"Ptag":'PTAG',	"Product Serial Number":'PRODUCT SERIAL NUMBER', 	"Issued on":"ISSUED ON",	"Bought For":"BOUGHT FOR" ,	"Employee ID":"EMPLOYEE ID",	"EMPLOYEE NAME":"EMPLOYEE NAME"}
TS_list_Details=["EMPLOYEE NAME",'EMPLOYEE ID','PRODUCT','ASSET ID', 'PTAG', 'PRODUCT SERIAL NUMBER', 'ISSUED ON', 'BOUGHT FOR']
#--------------------------------------To-Gether-------------------------------------------#
